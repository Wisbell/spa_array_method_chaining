/*
Using one single line of JavaScript code, complete the
following tasks on the array of integers below.
...
Then output (either in the DOM or the console) the sum of
all the resulting numbers.
*/
